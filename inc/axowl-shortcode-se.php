...
final class Axowl_shortcode_se {
	...
	public function sands2() {
        ...
        wp_enqueue_style('emaxowl-se-style', EM_AXOWL_SE_PLUGIN_URL.'assets/css/pub/emaxo-se2.css', array(), '0.0.6', '(min-width: 751px)');
        ...
        wp_enqueue_style('emaxowl-se-mobile', EM_AXOWL_SE_PLUGIN_URL.'assets/css/pub/emaxo-se2-mobile.css', array(), '0.0.6', '(max-width: 750px)');
        
        // wp_enqueue_script('jquery-touch');

        wp_enqueue_script('emaxowl-se', EM_AXOWL_SE_PLUGIN_URL.'assets/js/pub/emaxo-se2.js', [], '0.0.6', true);
	}
